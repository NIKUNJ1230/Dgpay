...
const Money_transfer1 = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const createResponse = await axios.post(
        ...
        {
          ...formData,
          section: 1, // Add additional fields if needed
        },
        {
          headers: {
            user_token: `${Allapi.token}`,
  ...
  const [selectedTranAcc, setSelectedTranAcc] = useState(null);
    ...
    <>
      <div className="card text-center">
        <div className="services">
          <h2>
            <span className="money-transfer">Services/Money Transfer 1</span>
          </h2>
        </div>
...
export default Money_transfer1;
