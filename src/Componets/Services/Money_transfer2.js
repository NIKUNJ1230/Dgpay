  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const createResponse = await axios.post(
        ...
        {
          ...formData,
         section: 2, // Add additional fields if needed
        },
        {
          headers: {
            user_token: `${Allapi.token}`,
  ...
  return (
    ...
    <div className="card text-center">
      <div className="services">
        <h2>
          <span className="money-transfer">Services/Money Transfer 2</span>
        </h2>
      </div>
...
export default Money_transfer2
